 ...
 */
package com.unit.base.zk.client;

import com.unit.base.zk.client.exception.ZkException;
import com.unit.base.zk.client.exception.ZkInterruptedException;
import com.unit.base.zk.client.exception.ZkNoNodeException;
import com.unit.base.zk.client.util.ZkPathUtil;
...
public class InMemoryConnection implements IZkConnection {
    ...
    /***
     *
     * @param path - path of znode we are accessing
     * @param perm - Privileges required for the action
